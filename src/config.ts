...
export const metis_sepolia = {
  ...
  blockExplorers: {
    default: { name: 'BlockScout', url: 'https://sepolia.explorer.metisdevops.link/' },
  },
...
export const config = defaultWagmiConfig({ 
  ...
  metadata: {
    ...
    icons: ["https://assets-global.website-files.com/6507242ad3e4e6ff563301e4/65456c8e4f6aaae6afc5eb7d_Symbol.svg"]
  } 
})