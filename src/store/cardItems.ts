...
export const szn1Cards: TCards[] = [
  {
    ...
    descriptionText:
      'Connect your wallet and claim your test tokens, clicking on "Start Now" will open a Telegram conversation with the bot that distributes the tokens. It is sufficient to click on "start" button and then bot will send you the tokens ',
    url: TG_BOT,
    // "videoUrl": "",
    buttonText: "Claim",
    history: [
...
export const szn2Cards = [
  ...
  },
  {
    ...
    history: [
      ...
      {
        stageName:
          "Stake ENKI to vest eMetis rewards from seMetis vault(vesting) (1500 pts)",
        id: "enkiStakeEnki",
        state: ItemStates.NOT_STARTED,
      },
    ],
